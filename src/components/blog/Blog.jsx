  ...
  return (
    <>
      <section className=" bg-[#241310] py-10">
        ...
        <div className="md:flex md:flex-col lg:flex-row text-white grid p-4 gap-8 lg:grid-cols-4 lg:items-center lg:text-left overflow-hidden container mx-auto">
          <div className="bg-orange-900 p-3 rounded-md ">
            <img
              ...
              className="md:w-full "
            />
            <h1 className="py-2  text-2xl text-center md:text-left">
              Bean of Himalaya
            </h1>
          ...
          <div className="bg-orange-900 p-3 rounded-md">
            ...
            <p className="text-center md:text-left text-sm nd">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Repellendus, quisquam. Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Sunt molestias ducimus
            </p>
